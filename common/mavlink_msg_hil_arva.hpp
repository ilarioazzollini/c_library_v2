// MESSAGE HIL_ARVA support class
...
/**
 * @brief HIL_ARVA message
 *
 * Arva measurement.
 */
struct HIL_ARVA : mavlink::Message {
    ...
    static constexpr auto NAME = "HIL_ARVA";
