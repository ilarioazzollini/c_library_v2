...
enum class TUNE_FORMAT : uint8_t
{
    QBASIC1_1=0, /* Format is QBasic 1.1 Play: https://www.qbasic.net/en/reference/qb11/Statement/PLAY-006.htm. | */
    MML_MODERN=1, /* Format is Modern Music Markup Language (MML): https://en.wikipedia.org/wiki/Music_Macro_Language#Modern_MML. | */
};

//! TUNE_FORMAT ENUM_END
constexpr auto TUNE_FORMAT_ENUM_END = 2;
...
#include "./mavlink_msg_hil_arva.hpp"
